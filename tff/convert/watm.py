...
*   `namespace`: the namespace of the annotation; an indicator where the
    ...
    *   `tei`: annotation comes
        [literally](https://annotation.github.io/text-fabric-factory/tff/convert/helpers.html#tff.convert.helpers.CM_LIT)
        from the TEI guidelines or the PageXML specification, or is
        [processed](https://annotation.github.io/text-fabric-factory/tff/convert/helpers.html#tff.convert.helpers.CM_LITP)
        straightforwardly from it;
    *   `tf`: annotation is
        [composed](https://annotation.github.io/text-fabric-factory/tff/convert/helpers.html#tff.convert.helpers.CM_LITC)
        in a more intricate way from the original source or even
        [added](https://annotation.github.io/text-fabric-factory/tff/convert/helpers.html#tff.convert.helpers.CM_PROV)
        to it;
    *   `nlp`: annotation is generated as a result of
        [NLP processing](https://annotation.github.io/text-fabric-factory/tff/convert/helpers.html#tff.convert.helpers.CM_NLP);
...
*   The TEI to TF conversion has lost the exact embedding of elements in the
    ...
    See `tff.convert.tei` under **parentEdges** and **siblingEdges**.
