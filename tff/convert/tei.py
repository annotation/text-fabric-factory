...
from tf.parameters import BRANCH_DEFAULT_NEW
from tf.fabric import Fabric
from tf.core.helpers import console, versionSort, mergeDict, readCfg
from tf.convert.walker import CV
from tf.core.timestamp import AUTO, DEEP, TERSE
from tf.core.command import readArgs
...
class TEI(CheckImport):
    def __init__(
        ...
        [transcription template](https://github.com/annotation/text-fabric-factory/blob/master/tff/convert/app/transcription.md).
